...
The data is deliberately moderate but broad: 4,200 entries share the substring
and approximate keys, while an indexed AND selects exactly 612 of them.  A
355-branch DN equality family exercises the same filters regardless of which
optional candidate-generation optimisations a server provides.
"""
